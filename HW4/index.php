...
$workxp = [ 
    [ 
        ...
        'date' => 'июль 2015 - по сей день', 
        'description' => 'Мой дядя самых честных правил,
    ...
    [ 
        'name' => 'WEB', 
        'date' => 'март 2012 - декабрь 2014', 
        'description' => 'Но, боже мой, какая скука
    ...
    [ 
        ...
        'description' => 'Так думал молодой повеса,
...
<div class="w3-twothird">
  ...
  <div class="w3-container w3-card w3-white w3-margin-bottom">
    ...
    <?php for($i=0; $i<count($workxp); ++$i):?>
    <div class="w3-container">
      <h5 class="w3-opacity"><b><?=$workxp[$i]['name']?></b></h5>
